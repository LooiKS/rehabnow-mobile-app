        ...
        ? Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // SizedBox(height: 10),
                // SizedBox(height: 10),
                // SkeletonPart(controller: _controller, width: 250),
                // SizedBox(height: 10),
                // SizedBox(height: 10),
                // SkeletonPart(controller: _controller, width: 200),
                // SizedBox(height: 10),
                // SizedBox(height: 10),
                // SizedBox(height: 10),
                // SizedBox(height: 10),
                // SkeletonPart(controller: _controller),
                // SizedBox(height: 10),
                // SizedBox(height: 10),
                // SkeletonPart(controller: _controller, width: 250),
                // SizedBox(height: 10),
                ...
                // SizedBox(height: 10),
                // SizedBox(height: 10),
                // SkeletonPart(controller: _controller, width: 150),
                // SizedBox(height: 10),
                // SizedBox(height: 10),
                // SkeletonPart(controller: _controller, width: 250),
                // SizedBox(height: 10),
